...
//
// หวยไทย (ใต้ดิน) มีผลรางวัล:
//   - Top3:    3 ตัวบน (3 ตัวท้ายของรางวัลที่ 1) เช่น "847"
//   - Top2:    2 ตัวบน (2 ตัวท้ายของ Top3) เช่น "47"
//   - Bottom2: 2 ตัวล่าง เช่น "56"
//   - Front3:  3 ตัวหน้า (3 ตัวแรกของรางวัลที่ 1) เช่น "491"
//   - Bottom3: 3 ตัวล่าง — ผลเลขท้าย 3 ตัว (อาจมีหลายรางวัล คั่นด้วย comma เช่น "123,456")
//
// หวยหุ้น / ยี่กี ใช้แค่ Top3, Top2, Bottom2
type RoundResult struct {
	Top3    string // 3 ตัวบน (3 ตัวท้ายของรางวัลที่ 1) เช่น "847"
	Top2    string // 2 ตัวบน (2 ตัวท้ายของ Top3) เช่น "47"
	Bottom2 string // 2 ตัวล่าง เช่น "56"
	Front3  string // 3 ตัวหน้า (3 ตัวแรกของรางวัลที่ 1) เช่น "491" — ใช้กับหวยไทย
	Bottom3 string // 3 ตัวล่าง เช่น "123,456" (หลายรางวัลคั่นด้วย comma) — ใช้กับหวยไทย
}
